...
async def send_mail(target: str, sender_name: str, title: str, msg: str) -> bool:
    ...
    try:
        async with aiosmtplib.SMTP(hostname=Config.mail_host) as server:
...
def send_mail_sync(target: str, sender_name: str, title: str, msg: str) -> bool:
    """
    发送纯文本邮件
    ...
    try:
        with smtplib.SMTP(Config.mail_host) as server:
